...
<div class="p-6 h-full overflow-y-auto box-border">
	...
	<div class="mb-4 flex gap-2">
		...
		<button class="px-6 py-3 rounded-xl font-medium bg-cyan-600 hover:bg-cyan-500 text-white disabled:opacity-50 cursor-pointer border-none" onclick={run} disabled={running}>{running ? 'Running...' : '▶ Run'}</button>
	</div>
